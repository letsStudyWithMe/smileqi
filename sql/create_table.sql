...
(
    ...
    `createBy`   VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci  DEFAULT '' COMMENT '创建者',
    `createTime` DATETIME                                                DEFAULT NULL COMMENT '创建时间',
    `updateBy`   VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci  DEFAULT '' COMMENT '更新者',
